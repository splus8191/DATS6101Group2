...
test<- t.test(spotify$songs_played_per_day, spotify$is_churned, conf.level = 0.90)
```
...
```{r}
spotify$listen_sub <- interaction(spotify$listening_category, spotify$subscription_type)
