...
ggplot(data = airdata1, aes(x = reorder(airline, airline, FUN = length))) +
  geom_bar(fill = "blue") +
  labs(
...
Justification: The number of rows (fivedelays_zero) will tell us how many flights were truly on time with no delay at all (neither 15 minutes as the convention).
```{r}
