...
let's convert `is_churned` to categories
```{r}
...
# SMART Question X: Do different subscription types (Free, Premium, Family, Student) influence users’ skip rates on spotify?
