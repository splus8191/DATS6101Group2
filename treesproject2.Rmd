...
flightdata <- flightdata %>%
  mutate(region = case_when(
    ...
    # 1. Northeast – now includes the last stragglers
    ...
    # 2. Midwest – added APN, BJI, BRD, DEC, DLH, EAU, HIB, INL, MCW, RHI
    ...
    # 3. Southeast – unchanged (already complete)
    ...
    # 4. South Central – added DDC, HYS, LBL, SLN, SWO
    ...
    # 5. West – unchanged (already had everything else)
...
```{r}  
library(randomForest)
# Make sure isDelayed is a factor (classification)
flightdata$isDelayed <- factor(flightdata$isDelayed, levels = c(0,1))
