...
```{r}
airdata <- read.csv("C:/Users/esche_zla0rp6/OneDrive - The George Washington University/Intro to Data Science/Data Science Project 2/Project 2 Airline Data Files/sample airline data.csv")
str(airdata)
...
# Statistical Tests [Muhannad explanation] & [Laura code]
...
We read the data in.
```{r}
flightdata = read.csv("C:/Users/esche_zla0rp6/OneDrive - The George Washington University/Intro to Data Science/Data Science Project 2/Project 2 Airline Data Files/LAirlinedata.csv")
```
...
csv_files <- list.files(
  path = "C:/Users/esche_zla0rp6/OneDrive - The George Washington University/Intro to Data Science/Data Science Project 2/Project 2 Airline Data Files/Jael months",
