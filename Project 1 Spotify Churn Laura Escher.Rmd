...
this is painful, lets do a heatmap or something. If nothing pops up here, it might be time to throw in the towel.
...
#get rid of user_id and is churned
...
#difference
spotifydifvec <- churned_means - active_means
...
ggplot(spotifydiffdf, aes(x = Feature, y = 1, fill = Difference)) +
  ...
  labs(title = "Difference Heatmap: Churned is Blue, Active is Red",
       y = NULL)

now i think we are getting somewhere, even if the result is marginal this shows something